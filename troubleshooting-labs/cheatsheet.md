# Troubleshooting Labs Cheatsheet

## 1. Quick Mental Model

Troubleshooting Labs should help you answer two questions quickly: where the control boundary is, and what evidence proves the runtime state matches the intended state.
