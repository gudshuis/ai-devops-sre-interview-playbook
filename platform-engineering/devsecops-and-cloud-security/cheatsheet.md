# Devsecops And Cloud Security Cheatsheet

## 1. Quick Mental Model

Devsecops And Cloud Security should help you answer two questions quickly: where the control boundary is, and what evidence proves the runtime state matches the intended state.
