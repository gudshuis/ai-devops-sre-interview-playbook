# Interview Question Bank Cheatsheet

## 1. Quick Mental Model

Interview Question Bank should help you answer two questions quickly: where the control boundary is, and what evidence proves the runtime state matches the intended state.
