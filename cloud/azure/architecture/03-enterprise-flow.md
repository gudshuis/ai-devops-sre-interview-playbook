# Azure Enterprise Flow

## Purpose

Explain how a workload on Azure should flow through identity, network, compute, data, and observability boundaries at the enterprise level.
