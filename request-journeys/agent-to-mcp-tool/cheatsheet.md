# Agent To MCP Tool Cheatsheet

## 1. Quick Mental Model

Agent To MCP Tool should help you answer two questions quickly: where the control boundary is, and what evidence proves the runtime state matches the intended state.
