# RAG Engineer — Basic Flow

## Purpose

This architecture shows how rag engineer thinking evolves from a minimal flow into an operable production design.
