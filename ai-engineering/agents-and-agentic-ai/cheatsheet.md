# Agents And Agentic AI Cheatsheet

## 1. Quick Mental Model

Agents And Agentic AI should help you answer two questions quickly: where the control boundary is, and what evidence proves the runtime state matches the intended state.
